  ...
  <modal name="error-modal" :classes="['v--modal', 'error-modal', hasBugs && 'has-bugs']" :pivot-y="0.2" :width="600" :height="400" @before-open="beforeOpen">
    <div class="error-modal-content">
      ...
      <div class="input-group input-group-lg">
        ...
        <input v-model="bugCount" onkeyup="value=value.replace(/[^1234567890-]+/g,'')" maxlength="8" type="text" class="form-control done" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
      </div>
